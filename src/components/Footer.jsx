...
export default function Footer() {
  const links = [
    { href: GITHUB, icon: <GH />, label: 'GitHub' },
    { href: LINKEDIN, icon: <LI />, label: 'LinkedIn' },
  ...
  return (
    <footer className="py-10 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: '#09090B' }}>
      ...
      <p className="text-center text-xs mt-6 font-mono" style={{ color: '#27272A' }}>
        © 2026 Shivansh Shekher Ojha
      </p>
    </footer>
  );
}
