...
export default function Footer() {
  ...
  return (
    <footer
      className="py-12 px-6 relative border-t"
      style={{ borderColor: 'rgba(145,94,255,0.1)', background: '#050816' }}
    >
      <div className="container mx-auto max-w-4xl flex flex-col items-center gap-6">
        ...
        <p className="text-xs text-center" style={{ color: '#6B7280' }}>
          Designed in Figma · Built with React, Three.js &amp; Framer Motion
        </p>
        ...
        <p className="text-xs" style={{ color: '#4B5563' }}>
          © 2026 Shivansh Shekher Ojha · All rights reserved.
        </p>
      </div>
    </footer>
  );
